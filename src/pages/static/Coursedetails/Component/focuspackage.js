        ...
        return (
            <div className='responsive'  style={{background:" #FFFFFF"}}>
                ...
                <Box sx={{
                    ...
                    >
                        <Typography style={{ fontWeight: "bold", fontSize: "17px" }}>Foundation contains 20 chapters Covering  </Typography>
                    </Stack>
                    <Stack spacing={2}
                        direction="row"
                        sx={{
                    ...
                    >
                        ...
                        <Typography style={{ width: "543px", fontWeight: "bold", fontSize: "17px" }}> whole syllabus of quants which have 50 videos, 50 pdf, 60 quizzes </Typography>
                    </Stack> </Box>
                ...
                <div class="coursesidebar" style={{height:"400px",marginTop:"-168px"}}>
                    ...
                    <a href="#SSC" style={{}}>In-depth Course</a>
                ...
                <div className="coursesmallbox" style={{ display: "flex", marginLeft: "1150px", marginTop: "-485px" }}>
                    <Box sx={{ maxWidth: "140%" }} >
