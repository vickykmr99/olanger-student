...
import "./course.css";
export default class trendQuestion extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div className='responsive' style={{ background: " #FFFFFF" }}>
                ...
                <div class="coursesidebar" style={{ height: "465px", marginTop: "-168px" }}>
                    <a href="#SSC">Foundation </a>

                    <a href="#SSC" >In-depth Course</a>
                    <a href="#services">Prev. year Paper Discussion</a>
                    <a href="#Banking & Insurance" style={{ fontWeight: "bolder", WebkitTextFillColor: "#3E30C2", fontSize: "11px", fontfamily: 'Poppins', justifyContent: "center", border: "2px solid #3E30C2", borderRadius: "5px" }}>Trend Questions of last 3yrs </a>
                        ...
                        <Accordion expanded={expanded === 'panel1'} onChange={this.handleChange('panel1')} style={this.getPanelStyle('panel1')}>
                            ...
                            >
                                <div style={{ display: "flex", justifyContent: "space-between" }}>
                                    <div style={{ marginRight: "459px" }}>
                                        <Button sx={{ fontWeight: "bold", color: 'black', textTransform: "capitalize" }} >
                                            Algebraic question
                                        </Button>
                                    </div>
                            ...
                            <AccordionDetails >
                                <hr style={{ width: "730px", marginTop: "15px", marginBottom: "20px", marginLeft: "-1%", marginRight: "2%", border: "1px solid #000" }} />
                                <Typography>
                                    10 algebric question from last 3 years
                                </Typography>
                                <div style={{ display: "flex", gap: "5px" }}>

                                    <Button sx={{ color: "#3E30C2", borderBottom: "solid 2px #3E30C2", borderRadius: "1px", textTransform: "capitalize", marginLeft: "600px", marginTop: "-29px" }} >
                                        3PDF
                                    </Button>
                                </div>
                ...
                <div className="coursesmallbox" style={{ display: "relative", marginLeft: "1131px", marginTop: "-502px" }}>
                    <Box sx={{ maxWidth: "140%" }} >
